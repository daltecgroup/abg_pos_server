...
router.post('/clockin', protect, upload.single('evidenceImage'), resizeAndSaveImage, clockIn); // MODIFIED: Added resizeAndSaveImage middleware
...
router.patch('/clockout/:id', protect, upload.single('evidenceImage'), resizeAndSaveImage, clockOut); // MODIFIED: Added resizeAndSaveImage middleware
...
router.get('/:id', protect, getAttendanceRecordById);
